...
namespace EasyTween
{
    public sealed class AnchoredPositionTween : BaseTween
    {
        ...
        public AnchoredPositionTween(RectTransform target, Vector2 value) : base()
        {
            this.target = target;
            this.value = value;
        }
        ...
        {
            target.anchoredPosition = Vector2.LerpUnclamped(startValue, endValue, ratio);
        }
